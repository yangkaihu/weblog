...
<div class="page page-1 active">
  <div class="conten-header">
    ...
    <div class="el-menu  menu" role="menubar" style="--el-menu-level: 0; width: 100%;border: none">
      <div></div>
      <div>weblog</div>
      ...
      <div class="el-menu el-menu--horizontal menu" role="menubar" style="--el-menu-level: 0;border: none">
        <span class="user-info"><span class="el-avatar el-avatar--circle el-tooltip__trigger"
                                      style="margin-right: 3rem;">登录</span>
        </span>
      </div>
    </div>
